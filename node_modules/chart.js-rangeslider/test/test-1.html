<!DOCTYPE html> <html lang="en"> <head> <meta charset="utf-8"> <title>Chart.js demo</title> <!-- import plugin script --> <script src="../dist/RangeSlider-all.min.js"></script> <link rel="stylesheet" href="../dist/RangeSlider-all.min.css"> <!-- local files, used for development 
	...
	-->  <body> <!-- line chart canvas element --> <canvas id="ini" width="500" height="300"></canvas> <script>//this is just for debug
