...
</code></pre> <p>Using pattern fills for data graphics can help viewers with vision deficiencies (e.g. color-blindness or partial sight) to <a href="http://betweentwobrackets.com/data-graphics-and-colour-vision/" target="_blank">more easily understand your data</a>.</p> <p>Using the <a href="https://github.com/ashiguruma/patternomaly" target="_blank">Patternomaly</a> library you can generate patterns to fill datasets.</p> <pre><code class="lang-javascript"><span class="hljs-keyword">var</span> chartData = {
    datasets: [{
...
</code></pre> </section> </div> <div class="search-results"> <div class="has-results"> <h1 class="search-results-title"><span class="search-results-count"></span> results matching "<span class="search-query"></span>"</h1> <ul class="search-results-list"></ul> </div> <div class="no-results"> <h1 class="search-results-title">No results matching "<span class="search-query"></span>"</h1> </div> </div> </div> </div> </div> </div> <a href="options.html" class="navigation navigation-prev" aria-label="Previous page: Options"> <i class="fa fa-angle-left"></i> </a> <a href="fonts.html" class="navigation navigation-next" aria-label="Next page: Fonts"> <i class="fa fa-angle-right"></i> </a> </div> <script>var gitbook = gitbook || [];
