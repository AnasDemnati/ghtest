...
</code></pre> <table> <thead> <tr> <th>Name <th>Type <th>Default <th>Description   <tbody> <tr> <td><code>defaultFontColor</code> <td><code>Color</code> <td><code>&apos;#666&apos;</code> <td>Default font color for all text.  <tr> <td><code>defaultFontFamily</code> <td><code>String</code> <td><code>&quot;&apos;Helvetica Neue&apos;, &apos;Helvetica&apos;, &apos;Arial&apos;, sans-serif&quot;</code> <td>Default font family for all text.  <tr> <td><code>defaultFontSize</code> <td><code>Number</code> <td><code>12</code> <td>Default font size (in px) for text. Does not apply to radialLinear scale point labels.  <tr> <td><code>defaultFontStyle</code> <td><code>String</code> <td><code>&apos;normal&apos;</code> <td>Default font style. Does not apply to tooltip title or footer. Does not apply to chart title.   </table> <h2 id="non-existant-fonts">Non-Existant Fonts</h2> <p>If a font is specified for a chart that does exist on the system, the browser will not apply the font when it is set. If you notice odd fonts appearing in your charts, check that the font you are applying exists on your system. See <a href="https://github.com/chartjs/Chart.js/issues/3318" target="_blank">issue 3318</a> for more details.</p> </section> </div> <div class="search-results"> <div class="has-results"> <h1 class="search-results-title"><span class="search-results-count"></span> results matching "<span class="search-query"></span>"</h1> <ul class="search-results-list"></ul> </div> <div class="no-results"> <h1 class="search-results-title">No results matching "<span class="search-query"></span>"</h1> </div> </div> </div> </div> </div> </div> <a href="colors.html" class="navigation navigation-prev" aria-label="Previous page: Colors"> <i class="fa fa-angle-left"></i> </a> <a href="../configuration/" class="navigation navigation-next" aria-label="Next page: Configuration"> <i class="fa fa-angle-right"></i> </a> </div> <script>var gitbook = gitbook || [];
