...
</code></pre> <h2 id="dataset-properties">Dataset Properties</h2> <p>The scatter chart supports all of the same properties as the <a href="line.html#dataset-properties">line chart</a>.</p> <h2 id="data-structure">Data Structure</h2> <p>Unlike the line chart where data can be supplied in two different formats, the scatter chart only accepts data in a point format.</p> <pre><code class="lang-javascript">data: [{
        x: <span class="hljs-number">10</span>,
...
</code></pre> </section> </div> <div class="search-results"> <div class="has-results"> <h1 class="search-results-title"><span class="search-results-count"></span> results matching "<span class="search-query"></span>"</h1> <ul class="search-results-list"></ul> </div> <div class="no-results"> <h1 class="search-results-title">No results matching "<span class="search-query"></span>"</h1> </div> </div> </div> </div> </div> </div> <a href="bubble.html" class="navigation navigation-prev" aria-label="Previous page: Bubble"> <i class="fa fa-angle-left"></i> </a> <a href="area.html" class="navigation navigation-next" aria-label="Next page: Area"> <i class="fa fa-angle-right"></i> </a> </div> <script>var gitbook = gitbook || [];
