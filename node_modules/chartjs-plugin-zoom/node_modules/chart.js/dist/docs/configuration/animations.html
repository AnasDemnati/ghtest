...
</code></pre> <p>The following example fills a progress bar during the chart animation.</p> <pre><code class="lang-javascript"><span class="hljs-keyword">var</span> chart = <span class="hljs-keyword">new</span> Chart(ctx, {
...
</code></pre> <p>Another example usage of these callbacks can be found on <a href="https://github.com/chartjs/Chart.js/blob/master/samples/advanced/progress-bar.html" target="_blank">Github</a>: this sample displays a progress bar showing how far along the animation is.</p> </section> </div> <div class="search-results"> <div class="has-results"> <h1 class="search-results-title"><span class="search-results-count"></span> results matching "<span class="search-query"></span>"</h1> <ul class="search-results-list"></ul> </div> <div class="no-results"> <h1 class="search-results-title">No results matching "<span class="search-query"></span>"</h1> </div> </div> </div> </div> </div> </div> <a href="./" class="navigation navigation-prev" aria-label="Previous page: Configuration"> <i class="fa fa-angle-left"></i> </a> <a href="layout.html" class="navigation navigation-next" aria-label="Next page: Layout"> <i class="fa fa-angle-right"></i> </a> </div> <script>var gitbook = gitbook || [];
