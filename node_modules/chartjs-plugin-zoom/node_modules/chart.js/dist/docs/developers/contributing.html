...
</code></pre> <p>More information can be found in <a href="https://github.com/chartjs/Chart.js/blob/master/gulpfile.js" target="_blank">gulpfile.js</a>.</p> <h1 id="bugs-and-issues">Bugs and Issues</h1> <p>Please report these on the GitHub page - at <a href="https://github.com/chartjs/Chart.js" target="_blank">github.com/chartjs/Chart.js</a>. Please do not use issues for support requests. For help using Chart.js, please take a look at the <a href="http://stackoverflow.com/questions/tagged/chartjs" target="_blank"><code>chartjs</code></a> tag on Stack Overflow.</p> <p>Well structured, detailed bug reports are hugely valuable for the project.</p> <p>Guidelines for reporting bugs:</p> <ul> <li>Check the issue search to see if it has already been reported</li> <li>Isolate the problem to a simple test case</li> <li>Please include a demonstration of the bug on a website such as <a href="http://jsbin.com/" target="_blank">JS Bin</a>, <a href="http://jsfiddle.net/" target="_blank">JS Fiddle</a>, or <a href="http://codepen.io/pen/" target="_blank">Codepen</a>. (<a href="http://codepen.io/pen?template=JXVYzq" target="_blank">Template</a>)</li> </ul> <p>Please provide any additional details associated with the bug, if it&apos;s browser or screen density specific, or only happens with a certain configuration or data.</p> </section> </div> <div class="search-results"> <div class="has-results"> <h1 class="search-results-title"><span class="search-results-count"></span> results matching "<span class="search-query"></span>"</h1> <ul class="search-results-list"></ul> </div> <div class="no-results"> <h1 class="search-results-title">No results matching "<span class="search-query"></span>"</h1> </div> </div> </div> </div> </div> </div> <a href="axes.html" class="navigation navigation-prev" aria-label="Previous page: New Axes"> <i class="fa fa-angle-left"></i> </a> <a href="../notes/" class="navigation navigation-next" aria-label="Next page: Additional Notes"> <i class="fa fa-angle-right"></i> </a> </div> <script>var gitbook = gitbook || [];
