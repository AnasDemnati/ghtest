...
</code></pre> <h2 id="scale-properties">Scale Properties</h2> <p>Scale instances are given the following properties during the fitting process.</p> <pre><code class="lang-javascript">{
...
</code></pre> <h2 id="scale-interface">Scale Interface</h2> <p>To work with Chart.js, custom scale types must implement the following interface.</p> <pre><code class="lang-javascript">{
...
</code></pre> <p>Optionally, the following methods may also be overwritten, but an implementation is already provided by the <code>Chart.Scale</code> base class.</p> <pre><code class="lang-javascript">    <span class="hljs-comment">// Transform the ticks array of the scale instance into strings. The default implementation simply calls this.options.ticks.callback(numericalTick, index, ticks);</span>
...
</code></pre> <p>The Core.Scale base class also has some utility functions that you may find useful.</p> <pre><code class="lang-javascript">{
...
</code></pre> </section> </div> <div class="search-results"> <div class="has-results"> <h1 class="search-results-title"><span class="search-results-count"></span> results matching "<span class="search-query"></span>"</h1> <ul class="search-results-list"></ul> </div> <div class="no-results"> <h1 class="search-results-title">No results matching "<span class="search-query"></span>"</h1> </div> </div> </div> </div> </div> </div> <a href="charts.html" class="navigation navigation-prev" aria-label="Previous page: New Charts"> <i class="fa fa-angle-left"></i> </a> <a href="contributing.html" class="navigation navigation-next" aria-label="Next page: Contributing"> <i class="fa fa-angle-right"></i> </a> </div> <script>var gitbook = gitbook || [];
