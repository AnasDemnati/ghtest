...
</code></pre> <h2 id="dataset-controller-interface">Dataset Controller Interface</h2> <p>Dataset controllers must implement the following interface.</p> <pre><code class="lang-javascript">{
...
</code></pre> <p>The following methods may optionally be overridden by derived dataset controllers</p> <pre><code class="lang-javascript">{
...
</code></pre> <h2 id="extending-existing-chart-types">Extending Existing Chart Types</h2> <p>Extending or replacing an existing controller type is easy. Simply replace the constructor for one of the built in types with your own.</p> <p>The built in controller types are:</p> <ul> <li><code>Chart.controllers.line</code></li> <li><code>Chart.controllers.bar</code></li> <li><code>Chart.controllers.radar</code></li> <li><code>Chart.controllers.doughnut</code></li> <li><code>Chart.controllers.polarArea</code></li> <li><code>Chart.controllers.bubble</code></li> </ul> <p>For example, to derive a new chart type that extends from a bubble chart, you would do the following.</p> <pre><code class="lang-javascript"><span class="hljs-comment">// Sets the default config for &apos;derivedBubble&apos; to be the same as the bubble defaults. </span>
...
</code></pre> <h3 id="bar-controller">Bar Controller</h3> <p>The bar controller has a special property that you should be aware of. To correctly calculate the width of a bar, the controller must determine the number of datasets that map to bars. To do this, the bar controller attaches a property <code>bar</code> to the dataset during initialization. If you are creating a replacement or updated bar controller, you should do the same. This will ensure that charts with regular bars and your new derived bars will work seamlessly.</p> </section> </div> <div class="search-results"> <div class="has-results"> <h1 class="search-results-title"><span class="search-results-count"></span> results matching "<span class="search-query"></span>"</h1> <ul class="search-results-list"></ul> </div> <div class="no-results"> <h1 class="search-results-title">No results matching "<span class="search-query"></span>"</h1> </div> </div> </div> </div> </div> </div> <a href="plugins.html" class="navigation navigation-prev" aria-label="Previous page: Plugins"> <i class="fa fa-angle-left"></i> </a> <a href="axes.html" class="navigation navigation-next" aria-label="Next page: New Axes"> <i class="fa fa-angle-right"></i> </a> </div> <script>var gitbook = gitbook || [];
