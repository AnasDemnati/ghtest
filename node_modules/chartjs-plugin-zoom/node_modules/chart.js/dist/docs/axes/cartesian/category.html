...
</code></pre> <p>As part of axis definition:</p> <pre><code class="lang-javascript"><span class="hljs-keyword">let</span> chart = <span class="hljs-keyword">new</span> Chart(ctx, {
    type: ...
    data: ...
    options: {
        scales: {
...
</code></pre> <h2 id="tick-configuration-options">Tick Configuration Options</h2> <p>The category scale provides the following options for configuring tick marks. They are nested in the <code>ticks</code> sub object. These options extend the <a href="./#tick-configuration">common tick configuration</a>.</p> <table> <thead> <tr> <th>Name <th>Type <th>Default <th>Description   <tbody> <tr> <td><code>labels</code> <td><code>Array[String]</code> <td>- <td>An array of labels to display.  <tr> <td><code>min</code> <td><code>String</code> <td> <td>The minimum item to display. <a href="#min-max-configuration">more...</a>  <tr> <td><code>max</code> <td><code>String</code> <td> <td>The maximum item to display. <a href="#min-max-configuration">more...</a>   </table> <h2 id="min-max-configuration">Min Max Configuration</h2> <p>For both the <code>min</code> and <code>max</code> properties, the value must be in the <code>labels</code> array. In the example below, the x axis would only display &quot;March&quot; through &quot;June&quot;.</p> <pre><code class="lang-javascript"><span class="hljs-keyword">let</span> chart = <span class="hljs-keyword">new</span> Chart(ctx, {
