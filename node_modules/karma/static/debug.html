...
--> <html> <head> %X_UA_COMPATIBLE% <title>Karma DEBUG RUNNER</title> <link href="favicon.ico" rel="icon" type="image/x-icon"> <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">  <body> <!-- The scripts need to be at the end of body, so that some test running frameworks
