...
code .this { color: #19469D; }</style> <script>$(function(){
...
}</code></pre>   <tr class="code"> <td class="docs"> <p>Start listening for requests</p> <h2></h2> <ul><li><p><strong>param</strong>: <em>Number</em> port The port number it should be listening to.</p></li><li><p><strong>param</strong>: <em>Server</em> server A HTTP server instance, this will be used to listen for inline requests</p></li><li><p><strong>param</strong>: <em>Function</em> cb The callback needs to be called once server is ready</p></li><li><p><strong>api</strong>: <em>public</em></p></li></ul>  <td class="code"> <pre><code><span class="class">Server</span>.<span class="variable">prototype</span>.<span class="variable">listen</span> = <span class="keyword">function</span> <span class="variable">listen</span>(<span class="variable">port</span>, <span class="variable">server</span>, <span class="variable">cb</span>){
  <span class="keyword">var</span> <span class="variable">me</span> = <span class="this">this</span>
...
};</code></pre>   <tr class="code"> <td class="docs"> <p>Adds a new origin to the Flash Policy File.</p> <h2></h2> <ul><li><p><strong>param</strong>: <em>Arguments</em> The origins that need to be added.</p></li><li><p><strong>api</strong>: <em>public</em></p></li></ul>  <td class="code"> <pre><code><span class="class">Server</span>.<span class="variable">prototype</span>.<span class="variable">add</span> = <span class="keyword">function</span> <span class="variable">add</span>(){
  ...
  <span class="this">this</span>.<span class="variable">compile</span>();
  <span class="keyword">return</span> <span class="this">this</span>;
};</code></pre>   <tr class="code"> <td class="docs"> <p>Removes a origin from the Flash Policy File.</p> <h2></h2> <ul><li><p><strong>param</strong>: <em>String</em> origin The origin that needs to be removed from the server</p></li><li><p><strong>api</strong>: <em>public</em></p></li></ul>  <td class="code"> <pre><code><span class="class">Server</span>.<span class="variable">prototype</span>.<span class="variable">remove</span> = <span class="keyword">function</span> <span class="variable">remove</span>(<span class="variable">origin</span>){
  ...
  <span class="keyword">return</span> <span class="this">this</span>;
};</code></pre>   <tr class="code"> <td class="docs"> <p>Closes and cleans up the server</p> <ul><li><p><strong>api</strong>: <em>public</em></p></li></ul>  <td class="code"> <pre><code><span class="class">Server</span>.<span class="variable">prototype</span>.<span class="variable">close</span> = <span class="keyword">function</span> <span class="variable">close</span>(){
...
});</code></pre>   <tr class="code"> <td class="docs"> <p>Creates a new server instance.</p> <h2></h2> <ul><li><p><strong>param</strong>: <em>Object</em> options A options object to override the default config</p></li><li><p><strong>param</strong>: <em>Array</em> origins The origins that should be allowed by the server</p></li><li><p><strong>api</strong>: <em>public</em></p></li></ul>  <td class="code"> <pre><code><span class="variable">exports</span>.<span class="variable">createServer</span> = <span class="keyword">function</span> <span class="variable">createServer</span>(<span class="variable">options</span>, <span class="variable">origins</span>){
...
};</code></pre>   <tr class="code"> <td class="docs"> <p>Provide a hook to the original server, so it can be extended if needed. </p>  <td class="code"> <pre><code><span class="variable">exports</span>.<span class="class">Server</span> = <span class="class">Server</span>;</code></pre>   <tr class="code"> <td class="docs"> <p>Module version </p>  <td class="code"> <pre><code><span class="variable">exports</span>.<span class="variable">version</span> = <span class="string">'0.0.2'</span>;
</code></pre>   </table> 