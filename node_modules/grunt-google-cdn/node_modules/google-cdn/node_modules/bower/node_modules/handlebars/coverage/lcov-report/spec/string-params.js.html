<!doctype html> <html lang="en"> <head> <title>Code coverage report for spec/string-params.js</title> <meta charset="utf-8"> <link rel="stylesheet" href="../prettify.css"> <style>body, html {
            margin:0; padding: 0;
        }
        body {
        ...
        .ignore-none { color: #999; font-weight: normal; }</style>  <body> <div class="header low"> <h1>Code coverage report for <span class="entity">spec/string-params.js</span></h1> <h2> Statements: <span class="metric">11.9% <small>(10 / 84)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Branches: <span class="metric">100% <small>(0 / 0)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Functions: <span class="metric">4.35% <small>(1 / 23)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Lines: <span class="metric">11.9% <small>(10 / 84)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp; </h2> <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">spec/</a> &#187; string-params.js</div> </div> <div class="body"> <pre><table class="coverage">
...
175
176
177<td class="line-coverage"><span class="cline-any cline-yes">3</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span><td class="text"><pre class="prettyprint lang-js">describe('string params mode', function() {
