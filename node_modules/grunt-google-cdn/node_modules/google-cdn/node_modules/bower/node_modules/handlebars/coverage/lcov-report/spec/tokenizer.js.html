<!doctype html> <html lang="en"> <head> <title>Code coverage report for spec/tokenizer.js</title> <meta charset="utf-8"> <link rel="stylesheet" href="../prettify.css"> <style>body, html {
            margin:0; padding: 0;
        }
        body {
        ...
        .ignore-none { color: #999; font-weight: normal; }</style>  <body> <div class="header low"> <h1>Code coverage report for <span class="entity">spec/tokenizer.js</span></h1> <h2> Statements: <span class="metric">20.91% <small>(55 / 263)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Branches: <span class="metric">22.22% <small>(2 / 9)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Functions: <span class="metric">1.89% <small>(1 / 53)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Lines: <span class="metric">20.91% <small>(55 / 263)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp; </h2> <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">spec/</a> &#187; tokenizer.js</div> </div> <div class="body"> <pre><table class="coverage">
...
401
402
403<td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span><td class="text"><pre class="prettyprint lang-js"><span class="fstat-no" title="function not covered">function shouldMatchTokens(result, tokens) {</span>
...
&nbsp;</pre>
</table></pre> </div> <div class="footer"> <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Aug 13 2014 23:50:21 GMT-0500 (CDT)</div> </div> <script src="../prettify.js"></script> <script src="https://yui-s.yahooapis.com/3.6.0/build/yui/yui-min.js"></script> <script>YUI().use('datatable', function (Y) {
