<!doctype html> <html lang="en"> <head> <title>Code coverage report for dist/cjs/handlebars/compiler/parser.js</title> <meta charset="utf-8"> <link rel="stylesheet" href="../../../../prettify.css"> <style>body, html {
            margin:0; padding: 0;
        }
        body {
        ...
        .ignore-none { color: #999; font-weight: normal; }</style>  <body> <div class="header high"> <h1>Code coverage report for <span class="entity">dist/cjs/handlebars/compiler/parser.js</span></h1> <h2> Statements: <span class="metric">100% <small>(396 / 396)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Branches: <span class="metric">100% <small>(205 / 205)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Functions: <span class="metric">100% <small>(27 / 27)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Lines: <span class="metric">100% <small>(369 / 369)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Ignored: <span class="metric">95 statements, 9 functions, 45 branches</span> &nbsp;&nbsp;&nbsp;&nbsp; </h2> <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">dist/cjs/handlebars/compiler/</a> &#187; parser.js</div> </div> <div class="body"> <pre><table class="coverage">
...
498
499
500<td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span><td class="text"><pre class="prettyprint lang-js">"use strict";
/* jshint ignore:start */
