<!doctype html> <html lang="en"> <head> <title>Code coverage report for spec/parser.js</title> <meta charset="utf-8"> <link rel="stylesheet" href="../prettify.css"> <style>body, html {
            margin:0; padding: 0;
        }
        body {
        ...
        .ignore-none { color: #999; font-weight: normal; }</style>  <body> <div class="header low"> <h1>Code coverage report for <span class="entity">spec/parser.js</span></h1> <h2> Statements: <span class="metric">37.5% <small>(39 / 104)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Branches: <span class="metric">100% <small>(2 / 2)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Functions: <span class="metric">4.44% <small>(2 / 45)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Lines: <span class="metric">37.5% <small>(39 / 104)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp; </h2> <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">spec/</a> &#187; parser.js</div> </div> <div class="body"> <pre><table class="coverage">
...
189
190
191<td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span><td class="text"><pre class="prettyprint lang-js">/*global Handlebars */
